...
export default function Industries({ asset }) {
  return <section className="industries section" id="industries" aria-labelledby="industries-title">
    <div className="container industry-grid">
                <div className="industry-image"><Image src={asset("pexels-solyartphotos-36488785.jpg")} alt="Offshore marine platform and support vessels" fill quality={90} sizes="(max-width: 800px) 100vw, 50vw" />
        </div>
